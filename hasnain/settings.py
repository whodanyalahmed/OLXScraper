"""
Django settings for hasnain project.
...
ALLOWED_HOSTS = ['0.0.0.0', 'localhost', '127.0.0.1',"http://olxscrapeer.herokuapp.com"]
...
WSGI_APPLICATION = 'hasnain.wsgi.application'
